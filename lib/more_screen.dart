...
import 'package:demo_app/patient_dashboard_screen.dart';
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildMenuItem('Reminders', Icons.arrow_forward_ios),
                    const SizedBox(height: 12),
                    _buildMenuItem('Settings', Icons.arrow_forward_ios),
                    const SizedBox(height: 12),
                    _buildMenuItem('Term & Conditions', Icons.arrow_forward_ios),
                    const SizedBox(height: 12),
                    _buildMenuItem('Help & Support', Icons.arrow_forward_ios),
                    const SizedBox(height: 12),
